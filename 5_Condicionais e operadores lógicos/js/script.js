...
// Else
// é um bloco que vai ser executado, se o if for false
...
// if: 1 apenas, não precisa de ninguem
// else if: posso ter N, mas preciso de if
// else: 1 apenas, preciso do if, e não do else if


// switch
// ele é bom para analisar casos com valores fixos, ex: dia da semana

// if: geralmente com itervalo de valores
...
// !EXP1 -> inverter o resultado boolean = true vira false, false vira true
...
// sempre viram booleao > true == true >> true, false == true >> false
